...
**Owner UI:** Telegram bot `@HappyCakeOwnerTest_bot` (long-poll, no tunnel)
...
|---|---|---|
| Owner approval bot | `@HappyCakeOwnerTest_bot` | One bot for all four flows. Long-poll, no tunnel. Commands: `/start /help /orders /custom /care /marketing /reports /status /replay /audit /whoami`. |
